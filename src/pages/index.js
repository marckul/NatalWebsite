          ...
          <div id="main" class="container d-flex flex-column justify-content-center full-height shadow-none ">  
            ...
            <div class="row my-5 py-5">
              ...
              <div class="col-md-6 d-flex py-5">
                <div class="mx-auto lead font-weight-normal">
                  <h2>Nasz adres</h2>
                  <address>
